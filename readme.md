...
1. Если рассматривать приложение на данном этапе изменений, то основной проблемой масштабирования будет
сваленый в кучу код, логика прописана внутри эндпоинтов, эндпоинты не разделены на группы.
2. Нет обработок ошибок и логирования, что в дальнейшем затруднит поиск проблем.
3. База данных на SQLite имеет ограничения как по скорости работы, так и по одновременному доступу к ней.
